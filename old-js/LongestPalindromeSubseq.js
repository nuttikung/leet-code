...
var longestPalindromeSubseq = function (s) {
    ...
    const memo = new Map()
    const answer = lps(0, s.length - 1, clone, memo)
    return answer
};

let start = Date.now();
// T1 s = "bbbab" -> 4
console.log(`s = "bbbab"`, longestPalindromeSubseq("bbbab"))
// T2 s = "cbbd" -> 2
console.log(`s = "cbbd"`, longestPalindromeSubseq("cbbd"))
// T3 s = 'a' -> 1
console.log(`s = 'a'`, longestPalindromeSubseq("a"))
// T4 s = 'abcba' -> 5
console.log(`s = 'abcba'`, longestPalindromeSubseq("abcba"))
// T5 s = 'abcbaa' -> 5
console.log(`s = 'abcbaa'`, longestPalindromeSubseq("abcbaa"))
